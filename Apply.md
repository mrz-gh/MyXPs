...
<div direction="rtl">
<li>
گواهی خروج از کشور برای ارمنستان برای کسانی است که معاف نيستند
</li>
</div>
...
---
⁣❇خلاصه و نکات مهم شرایط عکس استاندارد
1 - عکس 2*2 اینچ معادل 5.1*5.1 سانتی متر باشد (عکاسی ها همیشه 5*5 سانتی متر کراپ میکنند)
2 - عکس #حتما بدون روتوش و آرایش باشد. 
3 - نگاه بصورت #مستقیم باشد
4 - پشت زمینه عکس حتما سفید باشه
5 – هیچ سایه ای بر روی عکس نباشد 
6 - عکس حتما رنگی باشد (سیاه و سفید نباشد)
7 - استفاده از عینک طبی در عکس مجاز #نیست
8 - ⁣سر نباید به طرف بالا، پایین، چپ یا راست باشد
9 - ⁣صورت شخص باید مستقیما رو به دوربین باشد
10 - ⁣عکس گرفته شده نباید از شش ماه گذشته باشد.

12 - آرایش نکنید #مخصوصا آرایشی که مورد مشخصی از صورت را پنهان میکند ( خال، لَک و .. )
13 - عرض شانه حتما مشخص باشد
14 - فرمت عکس JPEG باشد
15 - کلاه و هدبند نداشته باشد
16 - از سینه به بالا نمایان باشد
17 - عکس مربعی باشد ( حداقل 600*600 پیکسل)
18 - در این لینک استاندارد طول سر و فاصله بین دو چشم مشخص شده است

⁣⁣❇ برای اینکه عکسی مطابق با شرایط فوق گرفته شود چکار کنیم؟
 
⁣✳ به عکاسی تشریف ببرین و با نشان دادن فایل pdf فوق و رعایت نکات مهم توسط خودتون (بدون آرایش، عینک و ...) پنج قطعه عکس استاندارد به علاوه فایل jpeg آنرا از عکاسی بگیرین. ( سفارت فقط دو نسخه نیاز دارد)
قابل ذکر است نسخه کراپ شده حتما به فرمت jpeg باشد با سایز 5.1*5.1 سانتی متر. (البته عکاسی های ایران 5*5 سانتی متر تحویل می دهند)

⁣✳ تشریف ببرین عکاسی و به عکاس محترم بگین که از سینه به بالا از شما عکس بگیرند با شرایط زیر
1 - کل فضای شانه گرفته شود
2 - به عکاس محترم بفرمائید #فایل_اصلی عکس #بدون_کراپ و _بدون_روتوش با فرمت JPEG بهتون بدهد (نمونه فایل اصلی عکس)
3 - یک سری (اکثرا سری شش تایی) کراپ شده 5.1*5.1 پرینت و بهتون بدهند
⁣⚠ با توجه به اینکه عکاسی ها نمی توانند کراپ 5.1*5.1 تحویل دهند (عکاسی های ایران 5*5 کراپ شده تحویل می دهند) و هنگام کراپ کردن گاها عکس کشیده می شود (طول سر و فاصله بین چشم ها از استاندارد خارج می شود)
...
⬛️قابل توجه متقاضیان بورس استانی برای دانشگاه پلی تکنیک میلان (پلیمی)

🔴#دفترچه راهنمای بورس استانی پلیمی سال تحصیلی قبل (2022-2023) حتما مطالعه شود.
لینک دفترچه: https://t.me/politecnicodimilanouniversity/352
متقاضیان برای #ترم_اول و #ترم_دوم همگی باید در یک ددلاین مشترک برای بورس استانی اقدام نمایند.
➖➖➖➖➖➖➖➖➖➖➖➖
◼️#مدارک لازم ( با توجه به بندوی سال قبل ):

1️⃣اسکن پاسپورت (نیاز به ترجمه ندارد)
2️⃣ترجمه شناسنامه #سرپرست : سرپرست بصورت پیش فرض پدر می باشد.
در صورت اعلام شدن مادر به عنوان سرپرست باید مدرکی دال بر طلاق یا از کار افتادگی یا فوت پدر ترجمه شود.

3️⃣ترجمه #اقرارنامه ( بدون ذکر عدم تملک )
#نمونه متن اقرارنامه:
https://t.me/politecnicodimilanouniversity/326
https://t.me/politecnicodimilanouniversity/191

4️⃣ترجمه #سند منزل یا #اجاره_نامه : باید شامل تاریخ 31 دسامبر سال 2022 برای سال تحصیلی 2023-2024 باشد.
🔺اجاره نامه: 
#تاریخ_ثبت : همان زمان مراجعه متقاضی به محضر یا بنگاه می باشد و قابل تغییر نیست.
#تاریخ_اجاره : این تاریخ باید قبل از 31 دسامبر باشد. 

5️⃣ترجمه #فیش_حقوقی_سالانه : بصورت جدولی یا متنی.
نمونه فیش حقوقی
https://t.me/politecnicodimilanouniversity/350
https://t.me/politecnicodimilanouniversity/190
https://t.me/politecnicodimilanouniversity/103

6️⃣رسید اپلای در فرم بورس استانی
➖➖➖➖➖➖➖➖➖➖➖➖
تمامی این 6 مورد طبق روند سال های قبل همراه با متنی که در دفترچه راهنما عنوان شده، به ایمیلی که در سایت دانشگاه ذکر خواهد شد، ارسال می شوند.

متعاقبا اگر با انتشار بندوی جدید تغییراتی حاصل شده بود به اطلاع خواهیم رساند.
➖➖➖➖➖➖➖➖➖➖➖➖
🟥 #مانده_حساب_31_دسامبر : این مورد تا سال قبل اجباری نبوده و اگر نیاز باشد به متقاضی بصورت ایمیل اطلاع خواهند داد.
متقاضیان به هیچ وجه این مورد را با مدارک اصلی ارسال نکنند. مگر اینکه امسال به عنوان یکی از مدارک اصلی معرفی شود.

🟥 #عدم_تملک در #اقرارنامه به هیچ وجه ذکر نشود.🟥

🔺تمامی #ترجمه ها برای بورس استانی باید به زبان ایتالیایی باشند.

#بورس #بورس_استانی #نمونه #فیش #فیش_حقوقی #اقرار_نامه #تاریخ #dsu #بندو 
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
✅لینک گروه پلیمی (پلیتکنیک میلان):
https://t.me/+Lrv1Ja_Ul-JmYjg0
🌐کانال مطالب جامع پلیمی:
@politecnicodimilanouniversity
📊کانال نتایج پذیرش پلیمی:
@Polimi_application_results
📕کانال کورس دیسکریپشن پلیمی:
@course_description
🟥⬜️🟩کانال نتایج ویزای پلیمی:
@POLIMI_VisaResults
🏦کانال نتایج ایزه پلیمی:
@POLIMI_ISEE_Results
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
...
توضیحات در مورد نحوه بورسیه استانی ایتالیا 

مدارک مورد نیاز برای ترجمه
1_شناسنامه
2_شناسنامه سرپرست(ترجیحا پدر)
3_سند ملک و یا اجاره نامه
سند ملک متراژ کمتری باشد عدد ایزه شما کمتر میشود و شانس دریافت بورسیه بیشتر خواهد شد 
این مدارک هر چه زود تر ترجمه شود بهتر میباشد
ترجمه فقط به زبان ایتالیایی 

4_گواهی مانده حساب 
5_فیش حقوقی سرپرست 
6_اقرار نامه

۳مدرک اخر بعد از مشخص شدن دانشگاه و استان ترجمه شود جون استان به استان متفاوت میباشد 

7_مانده حساب ۳۱دسامبر 
این مدرک نیازی به ترجمه نمیباشد 
...
مدارک (کلی) مورد نیاز برای اپلای مقطع کارشناسی ارشد:

• دانشنامه کارشناسی (مدرک موقت یا گواهی اشتغال به تحصیل) + ترجمه رسمی
• ریزنمرات کارشناسی + ترجمه رسمی
• رزومه تحصیلی
• توصیه‌نامه (با توجه به دانشگاه و رشته، اختیاری و اجباری)
• انگیزه‌نامه (عموما اجباری)
• پورتفولیو (برای رشته‌های مرتبط با دیزاین و معماری)
• گواهی سیستم نمره‌دهی + ترجمه رسمی (بنا به دانشگاه، اختیاری و اجباری)
• دانشنامه پیش دانشگاهی و دیپلم + ریزنمرات پیش دانشگاهی و دیپلم + ترجمه رسمی (تعداد دانشگاه‌های کمی هستند که برای اپلای مقطع کارشناسی ارشد، این مدارک رو از شما میخوان؛ برای مثال دانشگاه سپینزا رم)

ترجمه رسمی: توسط مترجم رسمی ترجمه میشه و دارای مهر و امضای مترجم رسمی باشه. (مهر دارالترجمه با مهر مترجم فرق داره و مهر دارالترجمه اعتبار خاصی نداره.)
دقت کنید که ترجمه رسمی، به معنی گرفتن تاییدات وزارت امور خارجه و دادگستری نیست.

#مدارک #اپلای



Amirreza, [3/12/2024 2:41 AM]
سند زیر صد متر و بنام سرپرست دنگ و فنگش کمتره

Amirreza, [3/12/2024 7:15 AM]
سلام دوستان اینی که میگین ترجمه شناسنامه ها یکی برای بورسیه یکی برای سفارت لازمه،نسخه دومش کپی برابر اصل باید بشه؟یا باید به خود دارالترجمه بگیم دو نسخه تحویل بده مثلا؟

Amirreza, [3/12/2024 7:15 AM]
دو نسخه از دارالترجمه

Amirreza, [3/13/2024 6:10 PM]
دوستان چه چیزایی رو دقیق باید بدیم دارالترجمه ایتالیایی؟ و حدود قیمت میدونید چقد میشه؟

Amirreza, [3/13/2024 6:10 PM]
مدارک سفارت که شامل اصل مدرک دیپلم و پیش دانشگاهی و ریزنمراتشونه
دانشنامه و ریزنمرات
شناسنامه خودت و سرپرست
حدودا ۴میلیون و ۳۰۰ شد برای من
مدارک بورس هم اجاره نامه و فیش حقوقی و اقرارنامه که حدودا ۳ تومن میشه

Amirreza, [3/13/2024 6:10 PM]
مرسی
مدارک بورس رو برای ویزا که نمیخاد؟ مرحله اخرش میشه درسته؟

Amirreza, [3/13/2024 6:10 PM]
من میخوام همین مدارک سفارت رو فعلا بدم ترجمه
کجا دادین شما؟

Amirreza, [3/13/2024 6:10 PM]
اره برای ویزا نمیخوانش 
اوایل تابستون مدارک بورس رو فقط تو خود سایت مربوطه باید آپلود کرد

Amirreza, [3/13/2024 6:10 PM]
دارالترجمه کاخ

Amirreza, [3/16/2024 11:49 AM]
یونیورسیتالی از اپریل باز میشه و بندو هم معمولاً توی جولای منتشر میشه



Amirreza, [2/25/2024 1:26 PM]
بچه ها تهران کجا ترجمه  ایتالیایی بدیم؟؟ که مناسب باشه قسمتش و زود بدن؟؟

Amirreza, [2/25/2024 1:26 PM]
ماسال،کاخ،الوند رو میگن خوبن

Amirreza, [3/3/2024 9:15 AM]
نقص مدرک سیاه میشه

Amirreza, [3/4/2024 8:58 AM]
من دیر فهمیدم تاریخ اشتغال به تحصیلی که اپلود کردم گذشته و باید تاریخ جدیدو اپلود کنم

Amirreza, [3/4/2024 8:58 AM]
من تجربه اش رو دارم. خود ادمیشن آفیس بهم پیام دادن که فایلت قدیمیه. منم گفتم که فرصت آپلود مدرک جدید ندارم چون نزدیک ددلاین بود. آخرش قبول کردن ازم

Amirreza, [3/5/2024 1:18 PM]
مدرک و ریزنمرات پیش و دیپلم
دانشنامه و ریزنمرات
شناسنامه خودت و سرپرست
من دو هفته پیش مدارک سفارتم رو به کاخ دادم شد ۴ و ۳۰۰
...
Amirreza, [3/5/2024 1:20 PM]
دوستان چجور اجاره نامه ای معتبره
