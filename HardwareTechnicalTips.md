...
2. [TOOLs](#tools)
    1. [🛠️ Simulators](#simulators)
          - [General-purpose simulators](#general-purpose-simulators)
          - [NoC Simulators](#noc-simulators)
          - [Memory Simulators](#simulators)
          - [DNN & Accelerator Simulators](#dnn-simulators)
3. [🧾 HDL ](#hdl)
    1. [HDL Comparison](#-hdl-comparison-table-2025)
    2. [🔬 HDL Simulators](#hdl-simulators)
    3. [⚙️ HDL Synthesizers](#hdl-synthesizers)
    4. [👁️ Waveform Viewers](#wave-viewers)
    5. [📘 VHDL/Verilog / SystemVerilog Notes](#vhdlverilogsystemverilog-tips)
4. [Automation](#automation)
5. [Hardware Concepts](#hardware-concepts)
   - [Bus Protocols](#bus-protocols)
6. [FPGAs](#fpgas)
7. [Material Technologies](#material-technologies)
...
- Unlike Verilog, where blocking (=) and non-blocking (<=) assignments are explicitly different, VHDL handles this differently depending on whether you're using signals or variables.
...
- using **"dumpvars"** and command-line mode with nodebug features is way faster that **gui mode and debug mode** of **questasim (and Modelsim)**. it can be used for **post-synthesized simulation**.
